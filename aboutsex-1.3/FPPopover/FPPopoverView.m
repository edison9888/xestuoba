...
#define FP_POPOVER_ARROW_BASE 7.0
#define FP_POPOVER_RADIUS 7.0
...
- (void)drawRect:(CGRect)rect
{
    ...
    //content fill
    CGPathRef contentPath = [self createContentPathWithBorderWidth:8.0 arrowDirection:_arrowDirection];
