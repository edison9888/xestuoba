...
- (void)viewDidLoad
{
    ...
    {        
        ...
        [sPageLoadingIndicator setCenter:self.tableView.center];
...
{
    self.mIsLoading = YES;
    NSString* sURLStr = URL_GET_FMS(self.mPageIndex++, FMS_PAGE_SIZE);
...
//    [[DownloadManager shared] startTaskForURL:aFMInfo.mDownloadURLStr withTaskID:aFMInfo.mID];
    ...
    [[DownloadManager shared] startTaskForURL:aFMInfo.mDownloadURLStr withFileName:aFMInfo.mName withProgressDelegate:nil withTaskID:aFMInfo.mID];
    [self refresh];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    else
    {
        ...
        if (!cell)
        {
            ...
            sIconImageView = [[UIImageView alloc] initWithFrame:CGRectMake(10, 10, 40, 40)];
            sIconImageView.image = [UIImage imageNamed:@"music"];
...
//        [sIconImageView setImage:[UIImage imageNamed:@"music"]];
        [sIconImageView setImageWithURL:[NSURL URLWithString:sFMInfo.mIconURLStr] placeholderImage:[UIImage imageNamed:@"love"]];
        ...
        else if (sFMInfo.mISDownloading)
        {
            ...
            //        [sBuyButton setNavigationButtonWithColor: RGBA_COLOR(145, 156, 118, 1)];
