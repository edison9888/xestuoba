...
{            
    ...
    if( sCell == nil )
    {
        ...
        //title label
        sTitleLabel = [[UILabel alloc]initWithFrame:CGRectMake(10, 8, 300, 30)];
        ...
        UIImageView* footView = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"dotline"]];
        [footView setFrame:CGRectMake(5, 42, 310, 2)];
        [sCell.contentView addSubview:footView];
        [footView release];
